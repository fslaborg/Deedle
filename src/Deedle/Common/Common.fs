...
module Formatting =
  ...
  /// behaviour of SaveCsv. DateTime keys with a time component are formatted using InvariantCulture
  /// to ensure consistent output (e.g. "01/01/2023 09:30:00") regardless of the system locale.
