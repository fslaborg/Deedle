...
categoryindex: 2
index: 5
description: Rich HTML formatting for Deedle frames and series in .NET Interactive notebooks (Jupyter, Polyglot Notebooks)
keywords: notebook, interactive, Jupyter, Polyglot, formatting, HTML, table
---
*)
(*** condition: prepare ***)
#nowarn "211"
...
#r "nuget: Deedle.DotNetInteractive,{{fsdocs-package-version}}"
#endif // FSX
(*** condition: prepare ***)
